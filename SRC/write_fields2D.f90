...
!=====================================================
  ...
  ! surface temperature
   ...
   name='TABS'
   long_name='Absolute air temperature at first level'
   units='K'
   call compress3D(tmp,nx,ny,1,name,long_name,units, &
        save2Dbin,dompi,rank,nsubdomains)
   ...
   name='W'
   long_name='Vertical wind speed at first level'
   units='m/s'
   call compress3D(tmp,nx,ny,1,name,long_name,units, &
        save2Dbin,dompi,rank,nsubdomains)
   ...
   do j=1,ny
      do i=1,nx
         tmp(i,j,1)=qv(i,j,1)*1.e3
      end do
   end do
   name='QV'
   long_name='Water vapor at first level'
   units='g/kg'
   call compress3D(tmp,nx,ny,1,name,long_name,units, &
        save2Dbin,dompi,rank,nsubdomains)
