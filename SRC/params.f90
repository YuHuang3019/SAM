...
integer::global_counter = 0! global counter for outputs so taht they are not too frequent
...
!real::   z0m    =0.035  ! roughness length for momentum
...
! nudging SST
logical:: dosstnudging = .false. ! nudging of SST: relax SST towards a defined value
real:: t_sst_nudge = 300 ! SST nudging temperature in K
real:: tau_nudge = 0.25 ! nudging time in days
...
integer:: nseedincrement  = 0 ! seed increment in the surface flux random initialization to generate different initial conditions
